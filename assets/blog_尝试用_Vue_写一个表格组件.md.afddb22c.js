...
<span class="line"><span style="color:#24292E;">    },</span></span>
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p>最后我们来看看最终实现效果。</p><p><img src="https://gitee.com/LibraHeresy/baidu-net-disk/raw/main/images/blog/202305291518102.png" alt="表格" title="表格"></p><p><img src="https://gitee.com/LibraHeresy/baidu-net-disk/raw/main/images/blog/202305291519542.png" alt="表格" title="表格"></p><h2 id="拓展" tabindex="-1">拓展 <a class="header-anchor" href="#拓展" aria-label="Permalink to &quot;拓展&quot;">​</a></h2><h3 id="fixed-属性" tabindex="-1">fixed 属性 <a class="header-anchor" href="#fixed-属性" aria-label="Permalink to &quot;fixed 属性&quot;">​</a></h3><p>产品总会提出一些很“合理”的需求，比如右边列固定。</p><p>没办法了，继续薅 <code>Antd</code> 的羊毛吧，在 <code>columns</code> 对象数组里面的对象上添加 <code>fixed</code> 属性。</p><h4 id="方案" tabindex="-1">方案 <a class="header-anchor" href="#方案" aria-label="Permalink to &quot;方案&quot;">​</a></h4><p>实现右边列固定我想过两个方案，最后选择 <code>方案 2</code>：</p><h5 id="_1-两个表格-一个表格固定在右边-用来展示有fixed属性的列" tabindex="-1">1. 两个表格，一个表格固定在右边，用来展示有<code>fixed</code>属性的列 <a class="header-anchor" href="#_1-两个表格-一个表格固定在右边-用来展示有fixed属性的列" aria-label="Permalink to &quot;1. 两个表格，一个表格固定在右边，用来展示有\`fixed\`属性的列&quot;">​</a></h5><p>实现简单，不用修改原有组件，但是我发现，会出现左右两个表格高度不一，所以放弃。</p><h5 id="_2-position-sticky-粘性定位" tabindex="-1">2. <code>position：sticky</code>，粘性定位 <a class="header-anchor" href="#_2-position-sticky-粘性定位" aria-label="Permalink to &quot;2. \`position：sticky\`，粘性定位&quot;">​</a></h5><p>这是一个很完美的 <code>css</code> 属性，需要注意的是生效先决条件比较多。</p><p>建议看看网上的 <a href="https://www.cnblogs.com/coco1s/p/14180476.html" target="_blank" rel="noreferrer">探究 position-sticky 失效问题</a> 这篇博客后，再开始使用粘性定位。</p><h4 id="问题" tabindex="-1">问题 <a class="header-anchor" href="#问题" aria-label="Permalink to &quot;问题&quot;">​</a></h4><p>实现途中还是出现了一些问题。</p><h5 id="_1-元素堆叠" tabindex="-1">1. 元素堆叠 <a class="header-anchor" href="#_1-元素堆叠" aria-label="Permalink to &quot;1. 元素堆叠&quot;">​</a></h5><p>我发现粘性定位会堆叠在一起，需要你手动调整元素位置，所以我选择将 <code>fixed</code> 列都放到一起，用一个容器包裹，这样只需要控制父容器位置就可以了。</p><p>那父容器的宽度如何设置呢，特别是 <code>fixed</code> 列单位有多种，如 <code>%</code> 和 <code>px</code> ，很自然的，我想到了计算属性 <code>calc()</code>，直接使用计算属性得出总宽度即可。</p><h5 id="_2-宽度失准" tabindex="-1">2. 宽度失准 <a class="header-anchor" href="#_2-宽度失准" aria-label="Permalink to &quot;2. 宽度失准&quot;">​</a></h5><p>我在外面设置的列宽度是根据表格宽度来设置的，但是用父容器包裹以后，锚点就从表格变成了父容器了，会出现宽度失准的问题。</p><p>但其实父容器的宽度就等于 <code>fixed</code> 列的总宽度，我们只要保证在父容器内部，各列的比例不变就可以实现宽度校准，用 <code>flex</code> 弹性布局的 <code>flex</code> 属性就可以实现这个效果。</p><h4 id="具体代码" tabindex="-1">具体代码 <a class="header-anchor" href="#具体代码" aria-label="Permalink to &quot;具体代码&quot;">​</a></h4><p>判断左右，控制组件展示</p><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">&lt;!-- 表头 --&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">style</span><span style="color:#24292E;">&gt;</span></span></code></pre></div>`,56),t=[o];function e(c,E,r,y,i,F){return n(),a("div",null,t)}const C=s(p,[["render",e]]);export{d as __pageData,C as default};
