...
<span class="line"><span style="color:#24292E;">},</span></span></code></pre></div><h3 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h3><p>指定 <code>DOM</code> 节点的宽高，并挂载到该节点上，就会自动渲染。</p><p><img src="https://gitee.com/LibraHeresy/baidu-net-disk/raw/main/images/blog/202309181352573.png" alt="图片" title="图片"></p><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p><code>WPS JS-SDK</code> 的使用过程非常顺滑，前端几乎不需要写什么代码，前后端总的来说，工作量都不大。</p><p>后端的工作量会更多一些，因为后端要对接 <code>WPS</code> 的接口，<code>WPS</code> 的读取、编辑和保存等操作，都需要后端提供接口支持。</p><p><code>WPS</code> 的 <code>JS-SDK</code> 是做的比较人性化的一个插件了。</p><h2 id="代码" tabindex="-1">代码 <a class="header-anchor" href="#代码" aria-label="Permalink to &quot;代码&quot;">​</a></h2><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
