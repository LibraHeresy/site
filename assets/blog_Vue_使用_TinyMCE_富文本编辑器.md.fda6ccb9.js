import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.28871c17.js";const d=JSON.parse('{"title":"Vue 使用 TinyMCE 富文本编辑器","description":"","frontmatter":{},"headers":[],"relativePath":"blog/Vue_使用_TinyMCE_富文本编辑器.md","filePath":"blog/Vue_使用_TinyMCE_富文本编辑器.md","lastUpdated":1694764389000}'),p={name:"blog/Vue_使用_TinyMCE_富文本编辑器.md"},o=l(`<h1 id="vue-使用-tinymce-富文本编辑器" tabindex="-1">Vue 使用 TinyMCE 富文本编辑器 <a class="header-anchor" href="#vue-使用-tinymce-富文本编辑器" aria-label="Permalink to &quot;Vue 使用 TinyMCE 富文本编辑器&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>说到富文本编辑器，<code>Quill</code> 是 Vue 开发者绕不开的，但遗憾的是，<code>Quill</code> 的 <code>Vue</code> 扩展 <code>vue-quill-editor</code> 在 5 年前停止更新了。</p><p>斯人已逝，我们迎来了新的富文本编辑器，<code>TinyMCE</code>！</p><p><a href="https://www.tiny.cloud/docs/tinymce/6/" target="_blank" rel="noreferrer">TinyMCE 官方文档</a></p><p><a href="http://tinymce.ax-z.cn/" target="_blank" rel="noreferrer">TinyMCE 中文文档</a></p><h2 id="环境" tabindex="-1">环境 <a class="header-anchor" href="#环境" aria-label="Permalink to &quot;环境&quot;">​</a></h2><blockquote><p>vue: 2.6.10</p><p>tinymce: 5.4.2</p><p>@tinymce/tinymce-vue: 3.2.3</p><p>copy-webpack-plugin: 6.1.1</p></blockquote><h2 id="实现" tabindex="-1">实现 <a class="header-anchor" href="#实现" aria-label="Permalink to &quot;实现&quot;">​</a></h2><h3 id="安装-tinymce-和-tinymce-tinymce-vue" tabindex="-1">安装 <code>tinymce</code> 和 <code>@tinymce/tinymce-vue</code> <a class="header-anchor" href="#安装-tinymce-和-tinymce-tinymce-vue" aria-label="Permalink to &quot;安装 \`tinymce\` 和 \`@tinymce/tinymce-vue\`&quot;">​</a></h3><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">yarn</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">add</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">tinymce</span></span>
