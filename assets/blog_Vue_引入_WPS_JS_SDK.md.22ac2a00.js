import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.28871c17.js";const F=JSON.parse('{"title":"Vue 引入 WPS JS-SDK","description":"","frontmatter":{},"headers":[],"relativePath":"blog/Vue_引入_WPS_JS_SDK.md","filePath":"blog/Vue_引入_WPS_JS_SDK.md","lastUpdated":1695016525000}'),p={name:"blog/Vue_引入_WPS_JS_SDK.md"},o=l(`<h1 id="vue-引入-wps-js-sdk" tabindex="-1">Vue 引入 WPS JS-SDK <a class="header-anchor" href="#vue-引入-wps-js-sdk" aria-label="Permalink to &quot;Vue 引入 WPS JS-SDK&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>因为业务觉得我们用开源插件开发的合同文件编辑不够强大，所以提出引入 WPS 的插件，满足现有合同编辑需求。</p><h2 id="环境" tabindex="-1">环境 <a class="header-anchor" href="#环境" aria-label="Permalink to &quot;环境&quot;">​</a></h2><blockquote><p>Vue v2.6.14</p><p>WPS JS-SDK v2.0.4</p></blockquote><h2 id="实现" tabindex="-1">实现 <a class="header-anchor" href="#实现" aria-label="Permalink to &quot;实现&quot;">​</a></h2><p><a href="https://solution.wps.cn/docs/web/quick-start.html" target="_blank" rel="noreferrer">WPS 快速开始</a>，先看看官方文档。</p><h3 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h3><p>因为我没有在 <a href="https://www.npmjs.com/" target="_blank" rel="noreferrer">npm</a> 上找到对应的官方包，所以我是下载下来本地引入的。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// wps-component.vue</span></span>
