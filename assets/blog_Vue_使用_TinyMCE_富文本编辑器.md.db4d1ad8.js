...
<span class="line"></span>
<span class="line"><span style="color:#6F42C1;">yarn</span><span style="color:#24292E;"> </span><span style="color:#032F62;">add</span><span style="color:#24292E;"> </span><span style="color:#032F62;">@tinymce/tinymce-vue</span></span></code></pre></div><h3 id="创建通用富文本组件" tabindex="-1">创建通用富文本组件 <a class="header-anchor" href="#创建通用富文本组件" aria-label="Permalink to &quot;创建通用富文本组件&quot;">​</a></h3><p>这种复用度高的组件，自然是要抽象为公共组件。</p><p>和很多组件包一样，<code>TinyMCE</code> 也是通过一个基础组件和配置参数对象来实现功能的。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 引入tinyMCE对象</span></span>
...
<span class="line"><span style="color:#24292E;">  },</span></span>
<span class="line"><span style="color:#24292E;">}</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><p>这样就可以了,在想要使用的地方直接引入。</p><p>如果想了解最新的功能，建议直接看 <a href="https://www.tiny.cloud/docs/tinymce/6/" target="_blank" rel="noreferrer">TinyMCE 官方文档</a>。</p><p>如果想了解 <code>API</code> ，建议看 <a href="http://tinymce.ax-z.cn/" target="_blank" rel="noreferrer">TinyMCE 中文文档</a>，但是只能用来参考。因为这个网站已经很久没更新了，而且他的用法主要围绕 <code>&lt;script /&gt;</code> 标签直接引入写的，并不怎么适合 <code>Vue</code>。</p><h2 id="问题" tabindex="-1">问题 <a class="header-anchor" href="#问题" aria-label="Permalink to &quot;问题&quot;">​</a></h2><h3 id="编辑器样式消失" tabindex="-1">编辑器样式消失 <a class="header-anchor" href="#编辑器样式消失" aria-label="Permalink to &quot;编辑器样式消失&quot;">​</a></h3><p>因为我的编辑器获取样式是相对路径，所以需要使用 <code>copy-webpack-plugin</code> 插件包，将静态文件不打包直接放到指定目录，建议是配置一个绝对路径。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#79B8FF;">module</span><span style="color:#E1E4E8;">.</span><span style="color:#79B8FF;">exports</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
